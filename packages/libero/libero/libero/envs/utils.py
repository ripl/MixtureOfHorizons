...
def postprocess_model_xml(xml_str, cameras_dict={}, demo_generation=False):
    ...
    # also replace paths for libero_scripts
    libero_path = os.getcwd() + "/libero_scripts"
    ...
    for elem in all_elements:
        ...
        elif "libero_scripts" in old_path_split and demo_generation:
            ind = max(
                loc for loc, val in enumerate(old_path_split) if val == "libero_scripts"
            )  # last occurrence index
